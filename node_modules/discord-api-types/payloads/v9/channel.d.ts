...
export type TextChannelType = ChannelType.DM | ChannelType.GroupDM | ChannelType.GuildAnnouncement | ChannelType.PublicThread | ChannelType.PrivateThread | ChannelType.AnnouncementThread | ChannelType.GuildText | ChannelType.GuildVoice | ChannelType.GuildStageVoice;
...
export interface APIGuildTextChannel<T extends GuildTextChannelType | ChannelType.GuildForum | ChannelType.GuildMedia> extends Omit<APITextBasedChannel<T>, 'name'>, APIGuildChannel<T> {
    /**
